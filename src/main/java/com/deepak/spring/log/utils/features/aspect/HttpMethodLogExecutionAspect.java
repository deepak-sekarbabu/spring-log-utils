package com.deepak.spring.log.utils.features.aspect;

import com.deepak.spring.log.utils.commons.LoggingCommonsMethods;
import com.deepak.spring.log.utils.features.annotations.HttpMethodLogExecution;
...
public class HttpMethodLogExecutionAspect {
     ...
     */
    @Around("@annotation(com.deepak.spring.log.utils.features.annotations.HttpMethodLogExecution)")
    @SneakyThrows
